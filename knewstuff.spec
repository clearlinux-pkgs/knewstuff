...
Version  : 5.109.0
Release  : 63
URL      : https://download.kde.org/stable/frameworks/5.109/knewstuff-5.109.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.109/knewstuff-5.109.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.109/knewstuff-5.109.0.tar.xz.sig
...
%prep
%setup -q -n knewstuff-5.109.0
cd %{_builddir}/knewstuff-5.109.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693244532
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5NewStuff.so.5.109.0
/V3/usr/lib64/libKF5NewStuffCore.so.5.109.0
/V3/usr/lib64/libKF5NewStuffWidgets.so.5.109.0
...
/usr/lib64/libKF5NewStuff.so.5.109.0
/usr/lib64/libKF5NewStuffCore.so.5
/usr/lib64/libKF5NewStuffCore.so.5.109.0
/usr/lib64/libKF5NewStuffWidgets.so.5
/usr/lib64/libKF5NewStuffWidgets.so.5.109.0
