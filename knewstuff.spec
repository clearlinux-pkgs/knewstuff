...
Source0  : https://download.kde.org/stable/frameworks/5.48/knewstuff-5.48.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.48/knewstuff-5.48.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1532101590
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5NewStuff.so.5.48.0
/usr/lib64/libKF5NewStuffCore.so.5
/usr/lib64/libKF5NewStuffCore.so.5.48.0
