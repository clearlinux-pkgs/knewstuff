...
Version  : 6.4.0
Release  : 79
URL      : https://download.kde.org/stable/frameworks/6.4/knewstuff-6.4.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.4/knewstuff-6.4.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.4/knewstuff-6.4.0.tar.xz.sig
...
%setup -q -n knewstuff-6.4.0
cd %{_builddir}/knewstuff-6.4.0
pushd ..
cp -a knewstuff-6.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721001206
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6NewStuffCore.so.6.4.0
/V3/usr/lib64/libKF6NewStuffWidgets.so.6.4.0
...
/usr/lib64/libKF6NewStuffCore.so.6.4.0
/usr/lib64/libKF6NewStuffWidgets.so.6
/usr/lib64/libKF6NewStuffWidgets.so.6.4.0
