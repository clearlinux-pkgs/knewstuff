...
Source0  : https://download.kde.org/stable/frameworks/5.68/knewstuff-5.68.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.68/knewstuff-5.68.0.tar.xz.sig
...
%prep
%setup -q -n knewstuff-5.68.0
cd %{_builddir}/knewstuff-5.68.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584324287
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/knewstuff-5.68.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/knewstuff/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5NewStuff.so.5.68.0
/usr/lib64/libKF5NewStuffCore.so.5
/usr/lib64/libKF5NewStuffCore.so.5.68.0
