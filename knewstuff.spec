...
Source0  : https://download.kde.org/stable/frameworks/5.89/knewstuff-5.89.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.89/knewstuff-5.89.0.tar.xz.sig
...
%prep
%setup -q -n knewstuff-5.89.0
cd %{_builddir}/knewstuff-5.89.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639700839
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/knewstuff-5.89.0/LICENSES/BSD-2-Clause.txt %{buildroot}/usr/share/package-licenses/knewstuff/ea97eb88ae53ec41e26f8542176ab986d7bc943a
cp %{_builddir}/knewstuff-5.89.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/knewstuff/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/knewstuff-5.89.0/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/knewstuff/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/knewstuff-5.89.0/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/knewstuff/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/knewstuff-5.89.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/knewstuff/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/knewstuff-5.89.0/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/knewstuff/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/knewstuff-5.89.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/knewstuff/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/knewstuff-5.89.0/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/knewstuff/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/knewstuff-5.89.0/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/knewstuff/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/knewstuff-5.89.0/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/knewstuff/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/knewstuff-5.89.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/knewstuff/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/knewstuff-5.89.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/knewstuff/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/knewstuff-5.89.0/src/qtquick/qmldir.license %{buildroot}/usr/share/package-licenses/knewstuff/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
cp %{_builddir}/knewstuff-5.89.0/tests/README.tests.license %{buildroot}/usr/share/package-licenses/knewstuff/cf81cd36721334c927a5c0efd351d9b610632518
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5NewStuff.so.5.89.0
/usr/lib64/libKF5NewStuffCore.so.5
/usr/lib64/libKF5NewStuffCore.so.5.89.0
