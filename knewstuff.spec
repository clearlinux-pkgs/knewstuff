...
Version  : 5.103.0
Release  : 56
URL      : https://download.kde.org/stable/frameworks/5.103/knewstuff-5.103.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.103/knewstuff-5.103.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.103/knewstuff-5.103.0.tar.xz.sig
...
%prep
%setup -q -n knewstuff-5.103.0
cd %{_builddir}/knewstuff-5.103.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676851079
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5NewStuff.so.5.103.0
/usr/lib64/libKF5NewStuffCore.so.5
/usr/lib64/libKF5NewStuffCore.so.5.103.0
/usr/lib64/libKF5NewStuffWidgets.so.5
/usr/lib64/libKF5NewStuffWidgets.so.5.103.0
